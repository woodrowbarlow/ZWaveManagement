...
public abstract class NanoHTTPD {
	...
	private static final Logger logger = LoggerFactory.getLogger(NanoHTTPD.class);
    ...
    public NanoHTTPD(String hostname, int port) {
    	if(hostname != null) logger.info("Constructing HTTP Server with hostname " + hostname + " on port " + port + ".");
    	else logger.info("Constructing HTTP Server on port " + port + ".");
    ...
    private static final void safeClose(Closeable closeable) {
        if (closeable != null) {
            try {
            	...
            	logger.error("HTTP Server failed to safely close.");
            }
        }
    }
    ...
    public void start() throws IOException {
        ...
        logger.trace("HTTP Server is spawning runtime thread.");
        ...
        logger.trace("HTTP Server is starting runtime thread.");
        myThread.start();
    }
     ...
     */
    public void stop() {
    	logger.trace("HTTP Server is stopping.");
        try {
        	...
        	logger.error("HTTP Server threw exception while stopping: ", e);
            e.printStackTrace();
        }
    }
